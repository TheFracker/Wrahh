...
public class HUD : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		GUI.Box (new Rect(screenWidth * 0.25f, screenHeight	* 0.02f, 150, 40),"Durabillity: " + player.CurrentWeapon.getDura() /*+ " Max: " + player.CurrentWeapon.getMAXDura()*/, StatsDisplay);
		GUI.Box (new Rect(screenWidth * 0.40f, screenHeight	* 0.02f, 150, 40),"Helm Armor: " + player.HelmArmor /*+ " Max: " + player.HelmMaxArmor*/, StatsDisplay);
		GUI.Box (new Rect(screenWidth * 0.55f, screenHeight	* 0.02f, 150, 40),"Shield Armor: " + player.ShieldArmor /*+ " Max: " + player.ShieldMaxArmor*/, StatsDisplay);
